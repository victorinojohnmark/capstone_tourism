...
<section class="bg-white dark:bg-gray-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl flex flex-col md:flex-row lg:py-16 lg:px-6">
        <div class="w-full md:w-2/3 font-light text-gray-500 sm:text-lg dark:text-gray-400 text-right {{ ($loop->index + 1) % 2 == 0 ? 'md:order-last !text-left': ''}}">
            ...
            <a href="/vendors/{{ $user->id }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</a>
        </div>
