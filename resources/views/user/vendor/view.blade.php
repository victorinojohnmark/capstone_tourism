    ...
    <div class="container mx-auto px-3 md:px-0">
        ...
        <section id="contactInformation" class="relative flex flex-col md:flex-row gap-4">
            ...
            <div class="w-full md:w-1/4">
                ...
                <a href="/messenger/{{ $user->id }}" class="mb-6 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Message Us</a>
            </div>
            @endif
