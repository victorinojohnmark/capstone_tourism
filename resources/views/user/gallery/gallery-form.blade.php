<div id="image-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="p-4 md:p-5 flex flex-col gap-y-3">
                ...
                <form action="{{ route('user.gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <input onchange="handleImageChange(this, 'imageViewer')" name="file_input" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
                    </div>
                    <img src="https://placehold.co/600x400?text=%2B" class="w-full" id="imageViewer" alt="">
                    <hr class="my-4">
