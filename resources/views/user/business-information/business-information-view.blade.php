        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div id="aboutUsContact" class="w-full md:w-1/3 p-3">
                ...
                <ul class="p-3 flex flex-row gap-3">
                    @if ($information->facebook_url)
                        <li>
                            <a href="{{ $information->facebook_url ?? '#' }}" target="_blank">
                    ...
                    <li>
                        <a href="{{ $information->instagram_url ?? '#' }}" target="_blank">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @endif
                    @if ($information->twitter_url)
                    <li>
                        <a href="{{ $information->twitter_url ?? '#' }}" target="_blank">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
