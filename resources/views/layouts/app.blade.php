                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li>
                                <a href="/vendors?type=Beach%20Resort" class="hover:underline">Beach Resorts</a>
                            </li>
                            <li>
                                <a href="/vendors?type=Restaurant" class="hover:underline">Restaurants</a>
                            </li>
                            <li>
                                <a href="/vendors?type=Products%20and%20Delicacies" class="hover:underline">Products and Delicacies</a>
                            </li>
                        </ul>
                    </div>
                    <div>
